...
class NatlinkEngine(EngineBase):
    ...
    def mimic(self, words):
        ...
        except self.natlink.MimicFailed, e:
            msg = "Error: No matching rule found for words: %r." % (prepared_words,)
            self._log.error(msg + ": " + str(e), exc_info=True)
            raise MimicFailure(msg, e)
